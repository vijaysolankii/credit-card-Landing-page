            ...
            <div className="wrapperNav">
              ...
              <ul className={`${isActive ? "active" : ""}`}>
                {navItems.map((item, index) => (
                  <li key={index}>
                    <a onClick={toggleMenu} className="hyperlink" href="#">
                      {item}
                    </a>
                  </li>
                ))}
